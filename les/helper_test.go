...
import (
	...
	"github.com/smartshareproject/smartshare/les/flowcontrol"
...
func newTestProtocolManager(lightSync bool, blocks int, generator func(int, *core.BlockGen), peers *peerSet, odr *LesOdr, db sspdb.Database) (*ProtocolManager, error) {
	var (
	...
	if lightSync {
		...
		bloomIndexer := ssp.NewBloomIndexer(db, params.BloomBitsBlocks)
...
// fails the test.
func newTestProtocolManagerMust(t *testing.T, lightSync bool, blocks int, generator func(int, *core.BlockGen), peers *peerSet, odr *LesOdr, db sspdb.Database) *ProtocolManager {
