...
type Database struct {
	diskdb sspdb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb sspdb.Database) *Database {
	return &Database{
		diskdb: diskdb,
...
func (db *Database) commit(hash common.Hash, batch sspdb.Batch) error {
	// If the node does not exist, it's a previously committed node
