...
As the dashboard depends on certain NPM packages (which are not included in the `smartshare` repo), these need to be installed first:
...
```
$ smartshare --dashboard --vmodule=dashboard=5
