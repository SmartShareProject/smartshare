...
func New(conf *Config) (*Node, error) {
	...
	// We rely on this in cmd/smartshare.
...
func (n *Node) OpenDatabase(name string, cache, handles int) (sspdb.Database, error) {
	if n.config.DataDir == "" {
		return sspdb.NewMemDatabase()
	}
	return sspdb.NewLDBDatabase(n.config.resolvePath(name), cache, handles)
}
