...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "smartshare.ipc", false, filepath.Join(os.TempDir(), "smartshare.ipc")},
		{"data", "smartshare.ipc", false, "data/smartshare.ipc"},
		{"data", "./smartshare.ipc", false, "./smartshare.ipc"},
		{"data", "/smartshare.ipc", false, "/smartshare.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "smartshare.ipc", true, `\\.\pipe\smartshare.ipc`},
		{"data", "smartshare.ipc", true, `\\.\pipe\smartshare.ipc`},
		{"data", `\\.\pipe\smartshare.ipc`, true, `\\.\pipe\smartshare.ipc`},
	}
