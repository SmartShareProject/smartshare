...
# 1. install smartshare for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for smartshare
# 5. create smartshare, attach and uninstall start menu entries
...
function .onInit
  # make vars are global for all users since smartshare is installed global
