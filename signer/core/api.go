...
import (
	...
	"github.com/smartshareproject/smartshare/accounts/usbwallet"
...
type ExternalAPI interface {
	...
	SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*sspapi.SignTransactionResult, error)
...
type SignerUI interface {
	...
	OnApprovedTx(tx sspapi.SignTransactionResult)
...
func (api *SignerAPI) SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*sspapi.SignTransactionResult, error) {
	var (
		err    error
	...
	response := sspapi.SignTransactionResult{Raw: rlpdata, Tx: signedTx}
...
//
// https://github.com/smartshareproject/smartshare/wiki/Management-APIs#personal_sign
...
// Note, this function is compatible with ssp_sign and personal_sign. As such it recovers
// the address of:
...
//
// https://github.com/smartshareproject/smartshare/wiki/Management-APIs#personal_ecRecover
