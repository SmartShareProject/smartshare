...
func newTestLDB() (*sspdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "sspdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := sspdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db sspdb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db sspdb.Database, t *testing.T) {
	const n = 8
