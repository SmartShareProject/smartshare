...
type testOdr struct {
	OdrBackend
	sdb, ldb sspdb.Database
	disable  bool
}

func (odr *testOdr) Database() sspdb.Database {
	return odr.ldb
}
...
type odrTestFn func(ctx context.Context, db sspdb.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) ([]byte, error)

func TestOdrGetBlockLes1(t *testing.T) { testChainOdr(t, 1, odrGetBlock) }

func odrGetBlock(ctx context.Context, db sspdb.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) ([]byte, error) {
...
func odrGetReceipts(ctx context.Context, db sspdb.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) ([]byte, error) {
...
func odrAccounts(ctx context.Context, db sspdb.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) ([]byte, error) {
...
func odrContractCall(ctx context.Context, db sspdb.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) ([]byte, error) {
