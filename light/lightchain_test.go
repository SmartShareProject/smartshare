...
func makeHeaderChain(parent *types.Header, n int, db sspdb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (sspdb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() sspdb.Database {
	return odr.db
}
