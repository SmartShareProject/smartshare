...
// account array.
func checkStateAccounts(t *testing.T, db sspdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db sspdb.Database, root common.Hash) error {
...
func checkStateConsistency(db sspdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(sspdb.Database), srcRoot)
