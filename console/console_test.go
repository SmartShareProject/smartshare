...
func newTester(t *testing.T, confOverride func(*eth.Config)) *tester {
	...
	if err = stack.Register(func(ctx *node.ServiceContext) (node.Service, error) { return ssp.New(ctx, ethConf) }); err != nil {
	...
	var smartshare *eth.Ethereum
	stack.Service(&smartshare)
