// Contains all the wrappers from the smartshare root package.
...
// the smartshare network.
type SyncProgress struct {
	progress smartshare.SyncProgress
}
