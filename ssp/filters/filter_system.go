// Package filters implements an smartshare filtering system for block,
...
type subscription struct {
	...
	typ       Type
	created   time.Time
	logsCrit  smartshare.FilterQuery
	logs      chan []*types.Log
...
func (es *EventSystem) SubscribeLogs(crit smartshare.FilterQuery, logs chan []*types.Log) (*Subscription, error) {
...
func (es *EventSystem) subscribeMinedPendingLogs(crit smartshare.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
...
func (es *EventSystem) subscribeLogs(crit smartshare.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
...
func (es *EventSystem) subscribePendingLogs(crit smartshare.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
