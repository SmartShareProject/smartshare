...
// Syncing provides information when this nodes starts synchronising with the Smartshare network and when it's finished.
...
type SyncingResult struct {
	...
	Status  smartshare.SyncProgress `json:"status"`
}
