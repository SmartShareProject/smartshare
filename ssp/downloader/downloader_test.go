...
type downloadTester struct {
	...
	stateDb sspdb.Database // Database used by the tester for syncing from peers
	peerDb  sspdb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb, _ = sspdb.NewMemDatabase()
