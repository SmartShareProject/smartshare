...
import (
	...
	"github.com/smartshareproject/smartshare/ssp/fetcher"
...
func NewProtocolManager(config *params.ChainConfig, mode downloader.SyncMode, networkId uint64, mux *event.TypeMux, txpool txPool, engine consensus.Engine, blockchain *core.BlockChain, chaindb sspdb.Database) (*ProtocolManager, error) {
...
func (pm *ProtocolManager) Stop() {
	log.Info("Stopping Smartshare protocol")
	...
	log.Info("Smartshare protocol stopped")
}
...
func (pm *ProtocolManager) handle(p *peer) error {
	...
	p.Log().Debug("Smartshare peer connected", "name", p.Name())
