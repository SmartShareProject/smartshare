...
type BloomIndexer struct {
	...
	db  sspdb.Database       // database instance to write index data and metadata into
...
func NewBloomIndexer(db sspdb.Database, size uint64) *core.ChainIndexer {
	backend := &BloomIndexer{
		db:   db,
		size: size,
	}
	table := sspdb.NewTable(db, string(core.BloomBitsIndexPrefix))
