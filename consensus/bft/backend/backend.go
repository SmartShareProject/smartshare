...
import (
	...
	bftCore "github.com/smartshareproject/smartshare/consensus/bft/core"
	"github.com/smartshareproject/smartshare/consensus/bft/validator"
...
func New(config *bft.Config, privateKey *ecdsa.PrivateKey, db sspdb.Database) consensus.BFT {
