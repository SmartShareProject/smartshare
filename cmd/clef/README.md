Clef
----
Clef can be used to sign transactions and data and is meant as a replacement for smartshare's account management.
This allows DApps not to depend on smartshare's account management. When a DApp wants to sign data it can send the data to
...
GLOBAL OPTIONS:
   ...
   --keystore value        Directory for the keystore (default: "$HOME/.smartshare/keystore")
...
The general flow for signing a transaction using e.g. smartshare is as follows:
![image](sign_flow.png)

In this case, `smartshare` would be started with `--externalsigner=http://localhost:8550` and would relay requests to `eth.sendTransaction`.
...
put together is a bit of a hack into the http server. This could probably be greatly improved
    - Relay: Geth should be started in `smartshare --external_signer localhost:8550`.
...
* Another potential thing to introduce is pairing.
  ...
  * Thus smartshare/mist/cpp would cryptographically handshake and afterwards the caller would be allowed to make signing requests.
...
The signer will generate a new private key, encrypts it according to [web3 keystore spec](https://github.com/smartshare/wiki/wiki/Web3-Secret-Storage-Definition) and stores it in the keystore directory.
...
#### Arguments
  - account [object]: key in [web3 keystore format](https://github.com/smartshare/wiki/wiki/Web3-Secret-Storage-Definition) (retrieved with account_export) 
...
#### Result
  - exported key, see [web3 keystore format](https://github.com/smartshare/wiki/wiki/Web3-Secret-Storage-Definition) for
  more information
  ...
  "params": [
    {
      "accounts": [
        {
          "type": "Account",
          "url": "keystore:///home/bazonk/.smartshare/keystore/UTC--2017-11-20T14-44-54.089682944Z--123409812340981234098123409812deadbeef42",
          "address": "0x123409812340981234098123409812deadbeef42"
        },
        {
          "type": "Account",
          "url": "keystore:///home/bazonk/.smartshare/keystore/UTC--2017-11-23T21-59-03.199240693Z--cafebabedeadbeef34098123409812deadbeef42",
...
* A Graphical UI MUST show the blocky-identicon for smartshare addresses.
